package 함수8_문제_리턴이차배열;

import java.util.Arrays;

public class 함수8_문제01_그룹바이_정답 {	
	
	public static String[][] getViewList(String [][] itemList) {
	...
	public static void printViewList(String [][] viewList) {
	...
	public static void updateViewList(String [][] viewList, int [][] orderList) {
		for(int i = 0; i < viewList.length; i++){
